# This file contains a handful of possible adjustments one might
# want for practical usage.
#
# Search "FEAT" and read the comments for more info
...
# Send and receive 32 bits synchronously
def GBA_Send32(val):
...
# Sends 32 bits, but does not wait for a USB reply.
# Useful for queueing up bulk transfers.
...
# Send and receive 32 bits synchronously, but does not wait forever
# if the GBA is unresponsive
...
# Sends 8 bits, but does not wait for a USB reply.
# Useful for queueing up bulk transfers.
...
# Send and receive 8 bits synchronously, but does not wait forever
# if the GBA is unresponsive
...
# Waits for multiboot comms to initiate
def wait_mb():
    # FEAT: This is to detect a payload instead of BIOS, and cancel mb sending
    '''
...
# FEAT: This is an example of sending additional data
'''
...
# FEAT: This is an example of an interactive-ish text console
'''
